...
def main():
    while(True):
        ...
        if bot == "1":
            ...
            os.system("cd ~/bully-master && cd src && make && sudo make install")
            time.sleep(2)
            os.system("clear && reset")
